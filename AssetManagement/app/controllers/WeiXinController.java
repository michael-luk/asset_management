...
public class WeiXinController extends Controller implements IConst {
    ...
    public static String wxMerchantId = "14470802";
    public static String wxMerchantApiKey = "c972e6bc45173081b739b6efa99b34";

//    public static String wxSecretId = "c4769db99d429c0c18bb63e498652e";
//    public static String wxAesKey = "YgVEG3AfIcq0yd5wfzgAtSwpF6XWZ7eaQhV1FXmz8";
//    public static String wxTokenStr = "fangngle";
    ...
    public static Result syncUserInfo() {
        ...
        try {
            ...
            for (String userOpenIds : wxUserList.getOpenIds()) {
                ...
                List<User> tryFoundUser = User.find.where().eq("thirdId", wxUser.getOpenId()).orderBy("id").findList();
                User user = null;
                ...
                if (user != null) {
                    ...
                    if (wxUser.isSubscribe()) {
                        ...
                        newUser.thirdId = wxUser.getOpenId();
...
//            switch (state) {
//                case "mine":
//                    User found = User.find.where().eq("thirdId", openId).findUnique();
...
//            }
    ...
    public static void handleWxUser(String openId, String resellerCode) throws WxErrorException {
        ...
        // 检查是否已经有关联用户
        List<User> tryFoundUser = User.find.where().eq("thirdId", openId).orderBy("id").findList();
        User found = null;
        if (tryFoundUser.size() > 0) {
