...
import static controllers.DbController.doDbBackupAndSendEmail;
                ...
                new Runnable() {
                    ...
                    public void run() {
                        if (controllers.Application.taskFlag) {
                            ...
                            doDbBackupAndSendEmail(controllers.Application.dbType);
                        } else {
                            play.Logger.info("DB BACKUP EVERY DAY - NOT RUN");
                        }
                    }
                },
